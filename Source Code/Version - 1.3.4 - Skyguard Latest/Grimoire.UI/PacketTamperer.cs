...
public class PacketTamperer : DarkForm
{
	...
	private void PacketTamperer_Shown(object sender, EventArgs e)
	{
	...
	private async void btnToClient_Click(object sender, EventArgs e)
	{
		if (!string.IsNullOrEmpty(txtSend.Text))
		{
			...
			bool flag = txtSend.Text.StartsWith("{");
			World.SendClientPacket(txtSend.Text, flag ? "json" : "str");
	...
	private async void btnToServer_Click(object sender, EventArgs e)
	{
		if (!string.IsNullOrEmpty(txtSend.Text))
		{
			...
			bool flag = txtSend.Text.StartsWith("{");
			World.SendPacket(txtSend.Text, flag ? "Json" : "String");
	...
	private void InitializeComponent()
	{
		...
		base.SuspendLayout();
		this.txtSend.BackColor = System.Drawing.Color.FromArgb(28, 32, 40);
		...
		this.txtSend.Text = "";
		this.txtReceive.BackColor = System.Drawing.Color.FromArgb(28, 32, 40);
		...
		this.btnToServer.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right;
		this.btnToServer.BackColor = System.Drawing.Color.FromArgb(45, 51, 66);
		...
		this.btnToServer.Click += new System.EventHandler(btnToServer_Click);
		...
		this.chkCapturePackets.CheckedChanged += new System.EventHandler(chkCapturePackets_CheckedChanged);
		this.btnToClient.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right;
		this.btnToClient.BackColor = System.Drawing.Color.FromArgb(45, 51, 66);
		...
		this.btnToClient.Click += new System.EventHandler(btnToClient_Click);
		...
		this.btnClearCaptured.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right;
		this.btnClearCaptured.BackColor = System.Drawing.Color.FromArgb(45, 51, 66);
		...
		this.btnClearCaptured.Click += new System.EventHandler(btnClearCaptured_Click);
		base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
		base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		this.BackColor = System.Drawing.Color.FromArgb(28, 32, 40);
		base.ClientSize = new System.Drawing.Size(561, 385);
		...
		base.TopMost = true;
		base.FormClosing += new System.Windows.Forms.FormClosingEventHandler(PacketTamperer_FormClosing);
		base.Shown += new System.EventHandler(PacketTamperer_Shown);
