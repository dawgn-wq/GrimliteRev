...
public class Quest
{
	...
	public bool IsInProgress => Flash.Call<bool>("IsInProgress", new string[1] { Id.ToString() });

	public bool CanComplete => Flash.Call<bool>("CanComplete", new string[1] { Id.ToString() });
